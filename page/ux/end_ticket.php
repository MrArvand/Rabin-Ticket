...
if ($kind == 'c') {
    ...
    $Qery .= "VALUES ('$code_pasokh_sys_escaped', '$code_ticket_escaped', '$code_p_run_escaped', '$name_run_escaped', '', '', '$matn_sys_escaped', '$tarikh', '$saat', '$revaziat2', 'cancel', 'n', '', '', NULL); ";
}
