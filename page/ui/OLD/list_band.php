      ...
      <div class="card-body">
        <div class="d-flex align-items-start align-items-sm-center gap-4">
        <div class="button-wrapper">
        <form  method="post"   action="?page=list_band&code_g=<?php echo $code_g; ?>&kind=<?php echo $kind; ?>" class="card-body">
        <div class="row g-3">
          ...
          <table class="table">
            <thead class="table-light">
              <tr>
                ...
                <th class="  fw-medium">نام</th>
                <th class="  fw-medium">دسته</th>
                <th class="  fw-medium">...</th>
              </tr>
            </thead>
 ...
 while($q_list_band=mysqli_fetch_array($Result_list)){
	 ...
	 ?>
              ...
              <tr>
                ...
                <td class=" ">
                <?php 
                if($q_list_band['kind_band']=="band")echo"بند";
                if($q_list_band['kind_band']=="tabsare")echo"تبصره"; ?>
                </td>
                <td class=" "><?php echo $q_list_band['name_band']; ?></td>
                <td class=" "><?php echo $q_list_band['daste']; ?></td>
                <td class=" "><a class="btn btn-outline-secondary" href="?page=info_band&code=<?php echo $q_list_band['code_band']; ?>"> ...</a></td>
              </tr>
              <?php }} ?>
            </tbody>
