...
<?php }} ?>
             ...
             <div class="col-xxl-12">
	      	...
	      	$shart= " ( code_p_karbar_anjam = '20612' || code_p_karbar_anjam = '23882'  || code_p_karbar_anjam = '8016' ||   code_p_karbar_anjam = '1100101'   ||   code_p_karbar_anjam = '25691'  ||   code_p_karbar_anjam = '80004'  ||   code_p_karbar_anjam = '26415'  ||   code_p_karbar_anjam = '29220'   ) AND i_ticket > 0 "   ;
...
$pasokh++;
 ...
 if($pasokh > 1){?>
  class="text-warning" <?php } ?> >
                               <a href="?page=info_ticket&code=<?php echo $cod_tiket_in ; ?>"> <?php echo $q_list['titr']; ?></a><br>
