	 ...
	 ?>  
              <div class="col-xxl-12">
                <div class="card mb-3">
                 ...
                 <span data-bs-toggle="modal" data-bs-target="#full_page"  class="btn btn-info card-btn">
انتخاب دسته آموزشی
                  </span>
 
 
                  <span data-bs-toggle="modal" data-bs-target="#full_page"  class="btn btn-success card-btn">
لیست بازدید ها
                  </span>
...
حذف این آموزش
 ...
 <h4><?php echo $q_list['titr']; ?></h4>
  ...
  <source src="<?php echo $q_list['link']; ?>"  type="video/mp4" poster="../files/poster/<?php echo $q_list['poster']; ?>">
<?php echo $q_list['titr']; ?>
</video>
                <?php }else{?>
                <img src="../files/poster/<?php echo $q_list['poster']; ?>" class="img-fluid w-500"  alt="<?php echo $q_list['titr']; ?>" />
                <?php } ?>
...
if($q_list['kind']=="3"){?>تخصصی<?php }  ?>            </a>
                  <p>
                    <ul>
                        <li> محور آموزش  : <?php echo $q_list['daste']; ?> </li>
                  ...
                  <p><?php echo nl2br( $q_list['matn']); ?> </p>
                   <?php if($q_list['link'] !=""){ ?>
                   <br>
                  <a href="<?php echo $q_list['link']; ?>" target="_blank" ></a><span class="text-warning"> در صورتی که آموزش تصویر برای شما اجرا نگردید اینجا کلیک نمایید </span>
                  <?php } ?>
                </div>
