                            ...
                            <div class="view-card ticket-card-clickable" data-ticket-code="<?php echo htmlspecialchars($ticket['code'], ENT_QUOTES, 'UTF-8'); ?>" data-category-id="<?php echo htmlspecialchars($categoryId, ENT_QUOTES, 'UTF-8'); ?>">
                                <div class="card-body p-3">
                                    ...
                                    <div class="d-flex flex-wrap gap-2 align-items-center">
                                        ...
                                        <span class="badge bg-primary view-badge">شرکت گیرنده: <?php echo htmlspecialchars($ticket['dept_company_name'], ENT_QUOTES, 'UTF-8'); ?></span>
                                        <?php endif; ?>
                                        <?php if (!empty($ticket['dept_division_name'])): ?>
                                        <span class="badge bg-info view-badge">معاونت: <?php echo htmlspecialchars($ticket['dept_division_name'], ENT_QUOTES, 'UTF-8'); ?></span>
                                        <?php endif; ?>
