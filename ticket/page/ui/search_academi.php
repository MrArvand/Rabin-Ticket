...
انتخاب دسته آموزشی
   ...
   <div class="col-md-6"> 
   <input type="text" value="<?php echo $search_t; ?>" name="search_t" id="search_t" class="form-control" dir="ltr" placeholder="" required > </div>
 ...
 <strong class="text-success text-center">
 	...
 	$Query_list="SELECT*from mohtava where (vaziat = 'y' AND titr like '%$search_t%')ORDER BY i_mohtava DESC LIMIT 1000 "; 
