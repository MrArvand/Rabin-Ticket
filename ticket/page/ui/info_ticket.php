...
?>
  ...
  <style>
    ...
    .ticket-status.status-a {
      background: rgba(191, 122, 106, 0.2);
      color: var(--bs-danger);
      border: 1px solid var(--bs-danger);
    }

    .ticket-status.status-m {
      background: rgba(111, 180, 206, 0.2);
      color: var(--bs-info);
      border: 1px solid var(--bs-info);
    }

    .ticket-status.status-w {
      background: rgba(60, 146, 177, 0.2);
      color: var(--bs-primary);
      border: 1px solid var(--bs-primary);
    }

    .ticket-status.status-b {
      background: rgba(169, 189, 122, 0.2);
      color: var(--bs-success);
      border: 1px solid var(--bs-success);
    }

    .ticket-status.status-k {
      background: rgba(210, 169, 104, 0.2);
  ...
  <div class="ticket-chat-container">
    ...
    <div class="chat-input-container" id="chat-input-container">
      ...
      <?php } else { ?>
        <div class="chat-input-wrapper p-3 text-center text-muted" style="background: var(--bs-gray-200); border-radius: 12px;">
